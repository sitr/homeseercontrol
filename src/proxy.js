...
import faye from require('faye');
import config from './config';


const LOCAL_PORT = config.homeseerProxyPort;
const REMOTE_ADDR = config.homeseerProxyHost;
const REMOTE_PORT = config.homeseerApiPort;
